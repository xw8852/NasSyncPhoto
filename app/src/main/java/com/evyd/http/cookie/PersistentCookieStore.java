...
public class PersistentCookieStore implements CookieStore {
    ...
    private void initCookies() {
        Map<String, Object> tempCookieMap = new HashMap<>(cookiePrefs.getAll());
        ...
        for (String key : tempCookieMap.keySet()) {
            ...
            for (String cookie : cookieNameArr) {
                String encoded = (String) tempCookieMap.get(COOKIE_NAME_PREFIX + cookie);
                if (encoded != null) {
                    this.cookies.get(key).put(cookie, decodeCookie(encoded));
                }
            }
        }
        tempCookieMap.clear();
